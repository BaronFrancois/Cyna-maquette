                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-3xl p-6 border border-blue-100">
                                ...
                                <p className="text-sm text-gray-500 mb-4">
                                    3 solutions supplémentaires sont disponibles pour renforcer votre sécurité.
                                </p>
                                <Link href="/catalog">
                    ...
                    {activeTab === "billing" && (
                        <div className="space-y-6">
                            <div>
                                ...
                                <p className="text-gray-500 text-sm mt-1">
                                    Historique et méthodes de paiement
                                </p>
                            </div>
                                    ...
                                    <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
                                        ...
                                        <div className="space-y-3">
                                            {[
                                                {
                                                    date: "01 fév. 2026",
                                                    label: "Abonnements Cyna — Fév. 2026",
                                                    amount: "69,98 €",
                                                    status: "Payée",
                                                },
                                                {
                                                    date: "01 jan. 2026",
                                                    label: "Abonnements Cyna — Jan. 2026",
                                                    amount: "69,98 €",
                                                    status: "Payée",
                                                },
                                                {
                                                    date: "01 déc. 2025",
                                                    label: "Abonnements Cyna — Déc. 2025",
                                                    amount: "69,98 €",
                                                    status: "Payée",
                                                },
                                                {
                                                    date: "01 nov. 2025",
                                                    label: "Abonnements Cyna — Nov. 2025",
                                                    amount: "69,98 €",
                                                    status: "Payée",
                                                },
                                            ].map((invoice, i) => (
